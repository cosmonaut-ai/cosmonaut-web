...
<div class="space-y-4">
	...
	<Button class="w-full" onclick={onSignIn} disabled={isSubmitting || !email || !password}>
		{#if isSubmitting}
			<Spinner class="mr-2" />
		{:else}
...
<p class="mt-6 text-center text-sm text-muted-foreground">
	...
	<button type="button" class="font-medium text-primary hover:underline" onclick={onSwitchToSignUp}>
		Sign up
	</button>
</p>
