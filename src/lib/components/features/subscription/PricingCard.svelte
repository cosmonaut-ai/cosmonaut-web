...
<style>
	.cosmonaut-glow::before {
		...
		background: conic-gradient(
			var(--cosmonaut-glow-1, oklch(0.75 0.12 80)),
			var(--cosmonaut-glow-2, oklch(0.65 0.12 290)),
			var(--cosmonaut-glow-3, oklch(0.65 0.1 190)),
			var(--cosmonaut-glow-1, oklch(0.75 0.12 80))
		);
	...
	.cosmonaut-glow {
		box-shadow:
			0 0 20px -5px oklch(0.75 0.12 80 / 0.15),
			0 0 40px -10px oklch(0.65 0.12 290 / 0.1);
	}
